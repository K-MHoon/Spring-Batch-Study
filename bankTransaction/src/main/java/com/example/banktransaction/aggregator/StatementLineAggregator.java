package com.example.banktransaction.aggregator;

import com.example.banktransaction.vo.Account;
import com.example.banktransaction.vo.Customer;
import com.example.banktransaction.vo.Statement;
import com.example.banktransaction.vo.Transaction;
...
public class StatementLineAggregator implements LineAggregator<Statement> {
    ...
    private static final String ADDRESS_LINE_THREE = String.format("%121s\n", "Seoul, IL 60613");
    ...
    private void formatHeader(Statement statement, StringBuilder output) {
        ...
        output.append(customer.getAddress1() +
                ADDRESS_LINE_TWO.substring(customer.getAddress1().length()));
        ...
        output.append(addressString +
                ADDRESS_LINE_THREE.substring(addressString.length()));
    }
}
